...
namespace Game2
{
	public class mFont
	{
		...
		{
			y0 += yAddFont;
			// Use a neutral style so Unity's skin cannot recolor labels when the mouse
			// enters their rectangle. Game fonts own all visual states themselves.
			GUIStyle gUIStyle = new GUIStyle();
			gUIStyle.font = myFont;
