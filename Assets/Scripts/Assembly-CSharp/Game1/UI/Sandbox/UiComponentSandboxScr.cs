...
namespace Game1.UI.Sandbox
{
    public class UiComponentSandboxScr : mScreen
    {
        ...
        public override void paint(mGraphics g)
        {
            ...
            // Title
            mFont.tahoma_7b_dark.drawString(g, "Game1 UI Sandbox", _mainFrameRect.X + _mainFrameRect.Width / 2, _mainFrameRect.Y + 8, mFont.CENTER);
            ...
            mFont.tahoma_7_white.drawString(g, "Tab: Game1", _diagRect.X + 4, _diagRect.Y + 40, mFont.LEFT);
